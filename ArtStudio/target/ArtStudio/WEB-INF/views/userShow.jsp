...
<body>
<%--<a href="${pageContext.request.contextPath}/user/addView" style="align-content: center">添加用户</a>--%>
<form action="${pageContext.request.contextPath}/user/addView" method="get">
    <input type="hidden" name="_method" value="INSERT">
    <input type="submit" value="新增账户" ></form>
<br>
...
<br>
<p align="center">当前表格共${page.pages}页、${page.total}条记录</p>
